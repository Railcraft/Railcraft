...
//            wrapper = new ShapedRecipesWrapper(jeiHelpers, (ShapedRecipes) recipe);
//            shaped = true;
//        } else if (recipe instanceof ShapelessRecipes) {
//            wrapper = new ShapelessRecipeWrapper<>(jeiHelpers, recipe);
//            shaped = false;
//        } else if (recipe instanceof ShapedOreRecipe) {
//            wrapper = new ShapedOreRecipeWrapper(jeiHelpers, (ShapedOreRecipe) recipe);
//            shaped = true;
//        } else if (recipe instanceof ShapelessOreRecipe) {
//            wrapper = new ShapelessRecipeWrapper<>(jeiHelpers, (ShapelessOreRecipe) recipe);
//            shaped = false;
