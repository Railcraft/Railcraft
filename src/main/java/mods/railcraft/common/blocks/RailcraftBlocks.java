...
public enum RailcraftBlocks implements IRailcraftBlockContainer {
    ...
    TANK_IRON_GAUGE(BlockDef.build("tank_iron_gauge", BlockTankIronGauge.class).item(ItemBlockMetalTank::new)),
    ...
    TANK_STEEL_GAUGE(BlockDef.build("tank_steel_gauge", BlockTankSteelGauge.class).item(ItemBlockMetalTank::new)),
