...
public enum RailcraftBlocks implements IRailcraftBlockContainer {
    ...
    BRICK_RED_NETHER("brick_rednether", BlockBrick.class, () -> new BlockBrick(BrickTheme.REDNETHER), ItemBrick::new),
    BRICK_RED_SANDY("brick_redsandy", BlockBrick.class, () -> new BlockBrick(BrickTheme.REDSANDY), ItemBrick::new),
