...
public enum Materials implements IVariantEnum {
    ...
    RED_NETHER_BLOCK(29, "red_nether_block", () -> BrickTheme.NETHER.getState(BrickVariant.BLOCK)),
    RED_NETHER_BRICK("red_nether_brick", Blocks.RED_NETHER_BRICK::getDefaultState),
    RED_NETHER_COBBLE(37, "red_nether_cobble", () -> BrickTheme.NETHER.getState(BrickVariant.COBBLE)),
    RED_NETHER_FITTED(21, "red_nether_fitted", () -> BrickTheme.NETHER.getState(BrickVariant.FITTED)),
    ...
    RED_SANDY_BLOCK(22, "red_sandy_block", () -> BrickTheme.REDSANDY.getState(BrickVariant.BLOCK)),
    RED_SANDY_BRICK(0, "red_sandy_brick", () -> BrickTheme.REDSANDY.getState(BrickVariant.BRICK)),
    RED_SANDY_COBBLE(30, "red_sandy_cobble", () -> BrickTheme.REDSANDY.getState(BrickVariant.COBBLE)),
    RED_SANDY_FITTED(14, "red_sandy_fitted", () -> BrickTheme.REDSANDY.getState(BrickVariant.FITTED)),
