 ...
 */
public abstract class RailcraftBlockContainerSubtyped extends RailcraftBlockContainer {
    private final Class<? extends IVariantEnum> variantClass;
    private final IVariantEnum[] variantValues;

    protected RailcraftBlockContainerSubtyped(Material materialIn, Class<? extends IVariantEnum> variantClass) {
        this(materialIn, materialIn.getMaterialMapColor(), variantClass);
    }

    protected RailcraftBlockContainerSubtyped(Material material, MapColor mapColor, Class<? extends IVariantEnum> variantClass) {
