 ...
 */
public abstract class RailcraftBlock extends Block implements IRailcraftBlock {
    protected RailcraftBlock(Material materialIn) {
        super(materialIn);
    }

    protected RailcraftBlock(Material material, MapColor mapColor) {
