...
public enum TrackKits implements IRailcraftObjectContainer<IRailcraftObject<TrackKit>> {
    ...
    THROTTLE(16, "throttle", 8, TrackKitThrottle.class, () -> recipe("dyeYellow", "dyeBlack", Items.REDSTONE)),
    LOCKING(16, "locking", 8, TrackKitLocking.class, () -> recipe(Blocks.STONE_PRESSURE_PLATE, Blocks.STICKY_PISTON, Items.REDSTONE)),
    DELAYED(3, "delayed", 8, TrackKitDelayedLocking.class, () -> recipe(Blocks.STONE_PRESSURE_PLATE, Blocks.STICKY_PISTON, Items.REPEATER)),
