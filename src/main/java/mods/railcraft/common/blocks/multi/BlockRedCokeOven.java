...
public class BlockRedCokeOven extends BlockMultiBlockInventory {

    public static final PropertyInteger ICON = PropertyInteger.create("icon", 0, 2);

    public BlockRedCokeOven() {
        super(Material.ROCK);
    ...
    @Override
    public Class<TileRedCokeOven> getTileClass(IBlockState state) {
        return TileRedCokeOven.class;
    }
