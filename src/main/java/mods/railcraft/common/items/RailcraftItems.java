...
public enum RailcraftItems implements IRailcraftObjectContainer<IRailcraftItem> {
    ...
    TURBINE_BLADE(ItemTurbineBlade::new, "turbine.blade", "ingotSteel", EnumMachineAlpha.TURBINE::isEnabled),
    TURBINE_DISK(ItemTurbineDisk::new, "turbine.disk", "blockSteel", EnumMachineAlpha.TURBINE::isEnabled),
    TURBINE_ROTOR(ItemTurbineRotor::new, "turbine.rotor", null, EnumMachineAlpha.TURBINE::isEnabled),
