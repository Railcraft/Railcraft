...
public class GuiSwitchMotor extends GuiContainerRailcraft {

    private final TileSwitchMotor actionManager;
    ...
    public GuiSwitchMotor(EntityPlayer player, TileSwitchMotor actionManager, String title) {
        super(new ContainerAspectAction(player, actionManager), RailcraftConstants.GUI_TEXTURE_FOLDER + "gui_switch_motor.png");
        ySize = 113;
        this.player = player;
        ...
        redstone = actionManager.doesActionOnRedstone();
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiToggleButton(5, w + 43, h + 80, 90, LocalizationPlugin.translate("railcraft.gui.switchmotor.button.redstone"), redstone));
        buttonList.add(lockButton = new GuiMultiButton(6, w + 152, h + 8, 16, actionManager.getLockController()));
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        if (button instanceof GuiToggleButton) {
            if (button.id <= 4) {
                ...
                redstone = !redstone;
                ((GuiToggleButton) button).active = redstone;
            }
        }
    }
    ...
    public void onGuiClosed() {
        if (changed && actionManager instanceof IGuiReturnHandler && canChange()) {
            ...
            actionManager.doActionOnRedstone(redstone);
