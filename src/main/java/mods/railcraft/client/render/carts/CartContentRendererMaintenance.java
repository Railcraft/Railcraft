 ...
 */
public class CartContentRendererMaintenance extends CartContentRenderer {
...
//    private static final ModelBase LAMP_ON = new ModelMaintanceLampOn();
    ...
    public void render(RenderCart renderer, EntityMinecart cart, float light, float partialTicks) {
        ...
        CartMaintenanceBase maintenance = (CartMaintenanceBase) cart;
        if (maintenance.isBlinking()) {
